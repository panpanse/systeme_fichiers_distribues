...
Une commande unique, à chaud pour le choix du nombre de répliquas, par fichier ou par répertoire.\\
Simplicité de l'extension de l'espace de stockage à chaud quelque soit la configuration, comprenant la ré-indexation des données.  \\
