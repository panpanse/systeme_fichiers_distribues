...
\begin{document}
	...
	\chapter{Introduction}
		...
		\section{Système de fichiers distribué}
			...
			sur des périphériques comme un disque dur, un CD-ROM, une clé USB, etc.
			...
			(les machines peuvent ainsi avoir accès à des fichiers distants, l'espace de noms est mis en commun).
			Un tel système permet donc de partager des données entre plusieurs clients,
...
Le principe de ce serveur est de récupérer tous les événements du système de fichier et peut permettre, si le maître est vraiment mal en point (perte de ses métadonnées, ou de son historique), de lui faire recupérer les données pour que le volume reste cohérent.\\
...
\end{center}
\end{figure} 
%Lecture de gros fichiers avec 5 serveurs
%\begin{figure}[H]
%\begin{center}
...
\end{center}
\end{figure} 
%Écriture de petits fichiers avec 5 serveurs
%\begin{figure}[H]
%\begin{center}
%\includegraphics[bb=0 0 640 480,width=14cm]{images/srv5ws.png}
%\caption{Lecture de petits fichiers avec 5 serveurs}
%\end{center}
%\end{figure} 
\begin{figure}[H]
\begin{center}
\includegraphics[bb=0 0 640 480,width=14cm]{images/srv5ws2.png}
\caption{Écriture de petits fichiers avec 5 serveurs}
\end{center}
\end{figure} 
%Écriture de gros fichiers avec 5 serveurs
%\begin{figure}[H]
%\begin{center}
%\includegraphics[bb=0 0 640 480,width=14cm]{images/srv5wb.png}
%\caption{Lecture de petits fichiers avec 5 serveurs}
%\end{center}
%\end{figure} 
\begin{figure}[H]
\begin{center}
\includegraphics[bb=0 0 640 480,width=14cm]{images/srv5wb2.png}
...
\end{figure} 
			...
			Mais si l'on se base sur nos résultats, nous constatons que les performance en écriture de GlusterFS sont de loin les meilleurs.\\
