...
Nous avons pu constater que cette étape ne fonctionné pas toujours très bien. Cela à pour conséquence de générer des dysfonctionnements surtout de type écriture.\\
Pour raisoudre cette mauvaise initialisation copier le fichier de transport manuellement dans /etc/glusterfs/.  
	\chapter{MooseFS}
