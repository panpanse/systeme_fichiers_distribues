...
[osd1]
 ...
 ssh node1 mount -o remount,user_xattr /tmp    # sur le second serveur depuis le moniteur
                        ...
                        Puis l'on créé le système de fichier avant de démarrer le service :
                        \begin{lstlisting}
			...
			\section{Répartition des taches}
				...
				\subsection{Maxime Douhéret}
					\begin{itemize}
						...
						\item Rédaction du rapporthttp://ceph.newdream.net/
					\end{itemize}
     ...
     \label{Sources}
			\begin{itemize}
				...
				\item Ceph : 
				  ...
				  \item Documentations de CephFS\footnote{\href{http://www.ssrc.ucsc.edu/Papers/weil-osdi06.pdf}{http://www.ssrc.ucsc.edu/Papers/weil-osdi06.pdf} \\\href{http://www.usenix.org/publications/login/2010-08/openpdfs/maltzahn.pdf}{http://www.usenix.org/publications/login/2010-08/openpdfs/maltzahn.pdf}}
				  \end{itemize}
			\end{itemize}
