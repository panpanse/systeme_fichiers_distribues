...
Pour raisoudre cette mauvaise initialisation, copier le fichier de transport manuellement dans /etc/glusterfs/ et remonté le volume pour recharger le fichier de configuration avec la commande :
\begin{lstlisting}
